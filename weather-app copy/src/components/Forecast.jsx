...
function Forecast({ weather }) {
  ...
  useEffect(() => {
    const fetchForecastData = async () => {
      ...
      // const url = `http://api.weatherapi.com/v1/forecast?key=<apiKey>&query=${data.city}&units=metric`;
      const url='http://api.weatherapi.com/v1/forcast.json?key=cbb3dd09eb154a7bac5202523251401&q='+data.city+'&aqi=yes';
